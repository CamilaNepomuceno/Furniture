...
namespace FurnitureStore.Domain.Concrete
{
    public class EmailSettings
    {
        ...
        public string MailFromAddress = "furniturestore@example.com";
        ...
        public string FileLocation = @"c:\furniture_store_emails";
    }
    ...
    public class EmailOrderProcessor :IOrderProcessor
    {
        ...
        public void ProcessOrder(Cart cart, ShippingDetails shippingInfo)
        {
            using (var smtpClient = new SmtpClient())
            {
                ...
                {
                    // Email will not be sent because it is a trial application.
                }
